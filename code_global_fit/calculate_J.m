% This subroutine calculates and returns the Jacobian matrix J, i.e., the 
% derivates of r (residue) with respect to interface positions, 
% Q (eigenvector matrix) and log of eigenvalues.

% An explicit expression of the Jacobian matrix can be found in Appendix A
% in Bai (2023).
